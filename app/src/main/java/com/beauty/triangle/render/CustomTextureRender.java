...
import com.beauty.triangle.MyGLSurfaceView;
...
public class CustomTextureRender implements MyGLSurfaceView.Renderer {
    ...
    public CustomTextureRender(Context mContext) {
        context=mContext;
